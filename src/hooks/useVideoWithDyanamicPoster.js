...
const useVideoWithDyanamicPoster = ({videoSource, frameIndex}) => {
  ...
  return {
    handleMouseEnter, handleMouseLeave, mobileOrTablet, poster, videoRef
  }
}

export default useVideoWithDyanamicPoster